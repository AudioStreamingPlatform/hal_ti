...
OBJ_DIR = ../../../obj/ticlang/m0p/drivers_mspm0l110x_l130x_nortos
SRC_DIR = ../../..

CFLAGS = -I$(TICLANG_ARMCOMPILER)/include "-I$(SDK_INSTALL_DIR)/source/third_party/CMSIS/Core/Include" "-I$(SDK_INSTALL_DIR)/source" -mcpu=cortex-m0plus -march=armv6-m -mtune=cortex-m0plus -mthumb -mfloat-abi=soft -DDeviceFamily_MSPM0L110X_L130X -DDRIVERS_NORTOS -D__MSPM0G3507__ -c -g -gstrict-dwarf -O2
AFLAGS = rc
